...
#define chk_arena_push_struct(arena, Type) chk_arena_push((arena), sizeof(Type))
#define chk_arena_push_array(arena, Type, count)                               \
    chk_arena_push((arena), sizeof(Type) * (count))
